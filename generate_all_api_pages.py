...
apis = [
    (
        ...
        "wikidata",
        "https://www.wikidata.org/w/api.php?action=wbsearchentities&search=Albert%20Einstein&language=en&format=json",
    ...
    (
        ...
        "Digital Library!",
        "internet-archive",
        "https://archive.org/advancedsearch.php?q=education&output=json&rows=5",
    ...
    (
        ...
        "Book Search!",
        "google-books",
        "https://www.googleapis.com/books/v1/volumes?q=education",
    ...
    (
        ...
        "Word Data!",
        "wordnik",
        "https://api.wordnik.com/v4/word.json/example/definitions?api_key=DEMO_KEY",
    ...
    (
        ...
        "Example Sentences!",
        "tatoeba",
        "https://tatoeba.org/eng/api_v0/search?query=hello",
        "Multilingual sentence database",
    ),
    (
        "rhymebrain",
        "🎵",
        ...
        "Rhyme Finder!",
        "rhymebrain",
        "https://rhymebrain.com/talk?function=getRhymes&word=cat",
    ...
    (
        ...
        "Species Data!",
        "gbif",
        "https://api.gbif.org/v1/species/search?q=puma",
    ...
    (
        ...
        "Nature Observations!",
        "inaturalist",
        "https://api.inaturalist.org/v1/observations?q=bird",
        "Community nature observations",
    ),
    (
        "openweather",
        "🌤️",
        ...
        "Weather Data!",
        "openweather",
        "https://api.openweathermap.org/data/2.5/weather?q=London&appid=DEMO_KEY",
        "Real-time weather",
    ),
    (
        "noaa",
    ...
    (
        ...
        "Number Sequences!",
        "oeis",
        "https://oeis.org/search?q=fibonacci&fmt=json",
    ...
    (
        ...
        "Dutch Art!",
        "rijksmuseum",
        "https://www.rijksmuseum.nl/api/en/collection?key=DEMO_KEY&q=rembrandt",
        "Dutch masterpieces",
    ),
    (
        "harvard_art",
        ...
        "Museum Collection!",
        "harvard-art",
        "https://api.harvardartmuseums.org/object?apikey=DEMO_KEY",
        "Harvard art museums",
    ),
    (
        "smithsonian",
        ...
        "Museum Data!",
        "smithsonian",
        "https://api.si.edu/openaccess/api/v1.0/search?q=art",
    ...
    (
        ...
        "European Culture!",
        "europeana",
        "https://api.europeana.eu/record/v2/search.json?wskey=DEMO_KEY&query=art",
    ...
    (
        ...
        "Digital Library!",
        "dpla",
        "https://api.dp.la/v2/items?q=history&api_key=DEMO_KEY",
    ...
    (
        ...
        "Free Images!",
        "openverse",
        "https://api.openverse.engineering/v1/images/?q=nature",
        "CC-licensed images",
    ),
    (
        "national_gallery",
    ...
    (
        ...
        "Free Dictionary!",
        "wiktionary",
        "https://en.wiktionary.org/w/api.php?action=query&titles=example&format=json",
    ...
    (
        ...
        "True Randomness!",
        "random-org",
        "https://www.random.org/integers/?num=10&min=1&max=100&col=1&base=10&format=plain",
        "True random numbers",
    ),
    (
        "xkcd",
...
for api_name, icon, title, subtitle, url_path, api_endpoint, description in apis:
    ...
    content = create_api_page(
        api_name, icon, title, subtitle, url_path, api_endpoint, description
    )
