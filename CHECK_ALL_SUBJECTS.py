...
def check_all_subjects():
    ...
    # Get all subjects
    cursor.execute("SELECT id, name, description, icon FROM subjects ORDER BY display_order")
    ...
    print("\n" + "=" * 60)
    print(f"TOTAL: {len(subjects)} SUBJECTS | {total_topics} TOPICS | {total_lessons} LESSONS")
    print("=" * 60)
