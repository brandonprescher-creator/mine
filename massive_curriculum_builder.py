...
class MassiveCurriculumBuilder:
    ...
    def create_comprehensive_lesson(
        self, topic_id: int, title: str, subject: str, subtopic: str
    ) -> int:
    ...
    def add_practice_problems_for_lesson(
        self, lesson_id: int, title: str, subject: str, subtopic: str
    ):
        ...
        for subject in subjects:
            ...
            for topic in topics:
                ...
                for category, subtopics in topic_set.items():
                    if (
                        category.lower() in topic["name"].lower()
                        or topic["name"].lower() in category.lower()
                    ):
