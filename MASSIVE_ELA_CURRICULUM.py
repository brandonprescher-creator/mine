...
def seed_massive_ela_curriculum():
    ...
    if existing_subjects and any(
        s["name"] == "English Language Arts" for s in existing_subjects
    ):
    ...
    k_phonics_id = add_topic(
        ela_id, "K - Phonics & Letter Sounds", "Learn letters and their sounds", 1
    )
    k_reading_id = add_topic(
        ela_id, "K - Beginning Reading", "Start reading simple words", 2
    )
    k_writing_id = add_topic(
        ela_id, "K - Pre-Writing Skills", "Learn to write letters and words", 3
    )
    k_speaking_id = add_topic(
        ela_id, "K - Speaking & Listening", "Talk and listen to others", 4
    )

    # GRADE 1 TOPICS
    g1_phonics_id = add_topic(
        ela_id, "1st - Advanced Phonics", "Master letter sounds and blends", 5
    )
    g1_reading_id = add_topic(
        ela_id, "1st - Reading Fluency", "Read smoothly and with expression", 6
    )
    g1_writing_id = add_topic(
        ela_id, "1st - Sentence Writing", "Write complete sentences", 7
    )
    g1_grammar_id = add_topic(
        ela_id, "1st - Basic Grammar", "Learn nouns, verbs, and adjectives", 8
    )

    # GRADE 2 TOPICS
    g2_phonics_id = add_topic(
        ela_id, "2nd - Complex Phonics", "Learn digraphs and diphthongs", 9
    )
    g2_reading_id = add_topic(
        ela_id, "2nd - Reading Comprehension", "Understand what you read", 10
    )
    g2_writing_id = add_topic(
        ela_id, "2nd - Paragraph Writing", "Write organized paragraphs", 11
    )
    g2_grammar_id = add_topic(
        ela_id, "2nd - Grammar Rules", "Master punctuation and capitalization", 12
    )

    # GRADE 3 TOPICS
    g3_reading_id = add_topic(
        ela_id, "3rd - Advanced Reading", "Read chapter books and analyze text", 13
    )
    g3_writing_id = add_topic(
        ela_id, "3rd - Multi-Paragraph Writing", "Write essays and stories", 14
    )
    g3_grammar_id = add_topic(
        ela_id, "3rd - Complex Grammar", "Learn advanced grammar rules", 15
    )
    g3_vocab_id = add_topic(
        ela_id, "3rd - Vocabulary Building", "Expand your word knowledge", 16
    )

    # GRADE 4 TOPICS
    g4_reading_id = add_topic(
        ela_id, "4th - Literary Analysis", "Analyze characters, plot, and theme", 17
    )
    g4_writing_id = add_topic(
        ela_id, "4th - Essay Writing", "Write persuasive and informative essays", 18
    )
    g4_grammar_id = add_topic(
        ela_id, "4th - Advanced Grammar", "Master complex sentence structures", 19
    )
    g4_vocab_id = add_topic(
        ela_id, "4th - Advanced Vocabulary", "Learn sophisticated words", 20
    )

    # GRADE 5 TOPICS
    g5_reading_id = add_topic(
        ela_id, "5th - Critical Reading", "Think critically about what you read", 21
    )
    g5_writing_id = add_topic(
        ela_id, "5th - Research Writing", "Research and write reports", 22
    )
    g5_grammar_id = add_topic(
        ela_id, "5th - Grammar Mastery", "Perfect your grammar skills", 23
    )
    g5_vocab_id = add_topic(
        ela_id, "5th - Academic Vocabulary", "Learn subject-specific words", 24
    )

    # GRADE 6 TOPICS
    g6_reading_id = add_topic(
        ela_id, "6th - Literature Study", "Study classic and modern literature", 25
    )
    g6_writing_id = add_topic(
        ela_id, "6th - Creative Writing", "Write stories, poems, and scripts", 26
    )
    g6_grammar_id = add_topic(
        ela_id, "6th - Style & Voice", "Develop your writing style", 27
    )
    g6_vocab_id = add_topic(
        ela_id, "6th - Etymology", "Learn word origins and roots", 28
    )

    # GRADE 7 TOPICS
    g7_reading_id = add_topic(
        ela_id, "7th - Advanced Literature", "Analyze complex texts and themes", 29
    )
    g7_writing_id = add_topic(
        ela_id, "7th - Argumentative Writing", "Write convincing arguments", 30
    )
    g7_grammar_id = add_topic(
        ela_id, "7th - Rhetorical Devices", "Use literary techniques", 31
    )
    g7_vocab_id = add_topic(
        ela_id, "7th - SAT Vocabulary", "Prepare for standardized tests", 32
    )

    # GRADE 8 TOPICS
    g8_reading_id = add_topic(
        ela_id, "8th - College Prep Reading", "Prepare for high school reading", 33
    )
    g8_writing_id = add_topic(
        ela_id, "8th - Research Papers", "Write formal research papers", 34
    )
    g8_grammar_id = add_topic(
        ela_id, "8th - Advanced Style", "Master sophisticated writing", 35
    )
    g8_vocab_id = add_topic(
        ela_id, "8th - Academic Language", "Master academic vocabulary", 36
    )

    # SPECIALIZED TOPICS
    poetry_id = add_topic(
        ela_id, "Poetry & Creative Writing", "Write and analyze poetry", 37
    )
    drama_id = add_topic(
        ela_id, "Drama & Performance", "Act, direct, and write plays", 38
    )
    media_id = add_topic(
        ela_id, "Media Literacy", "Analyze news, ads, and digital content", 39
    )
    public_speaking_id = add_topic(
        ela_id, "Public Speaking", "Present with confidence", 40
    )
    debate_id = add_topic(
        ela_id, "Debate & Discussion", "Argue persuasively and respectfully", 41
    )
    journalism_id = add_topic(
        ela_id, "Journalism & News Writing", "Write news articles and reports", 42
    )
    technical_writing_id = add_topic(
        ela_id, "Technical Writing", "Write instructions and manuals", 43
    )
    business_writing_id = add_topic(
        ela_id, "Business Writing", "Write emails, letters, and proposals", 44
    )
...
def seed_kindergarten_lessons(phonics_id, reading_id, writing_id, speaking_id):
    ...
    lesson_id = add_lesson(
        phonics_id,
        "Letter B - Sound and Recognition",
        "Learn the letter B and its sound",
        [
    ...
    lesson_id = add_lesson(
        phonics_id,
        "Letter C - Sound and Recognition",
        "Learn the letter C and its sound",
        [
    ...
    lesson_id = add_lesson(
        reading_id,
        "Sight Words - The, A, An",
        "Learn more important sight words",
        [
    ...
    lesson_id = add_lesson(
        speaking_id,
        "Speaking Clearly",
        "Learn to speak so others can understand",
        [
        ...
        [
            {
                "title": "Example",
                "content": "When sharing news, say: 'I want to tell you about...'",
            }
        ],
        "builtin",
        None,
...
def seed_grade1_lessons(phonics_id, reading_id, writing_id, grammar_id):
    ...
    lesson_id = add_lesson(
        phonics_id,
        "Short Vowel Sounds",
        "Master the five short vowel sounds",
        [
        ...
        [
            {
                "title": "Examples",
                "content": "cat, bed, sit, hot, cup - each has a short vowel sound",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        phonics_id,
        "Consonant Blends",
        "Learn to blend consonant sounds",
        [
    ...
    lesson_id = add_lesson(
        ...
        "Read smoothly and with feeling",
        [
        ...
        [
            {
                "title": "Example",
                "content": "'Hello!' said the happy cat. 'How are you?'",
            }
        ],
        "builtin",
        None,
...
def seed_grade2_lessons(phonics_id, reading_id, writing_id, grammar_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Examples",
                "content": "ship, chair, think, what, fish, much, bath, when",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        phonics_id,
        "Long Vowel Sounds",
        "Learn when vowels say their name",
        [
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Story about dogs being good pets. Main idea: Dogs make wonderful pets for families.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Topic: My Pet. Topic sentence: I have a wonderful dog named Max. Details: He is brown, he likes to play, he is very friendly. Closing: Max is the best pet ever.",
            }
        ],
        "builtin",
        None,
...
def seed_grade3_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        reading_id,
        "Character Analysis",
        "Understand characters in stories",
        [
        ...
        [
            {
                "title": "Example",
                "content": "In 'The Three Little Pigs,' the wolf is mean and tricky, but the pigs are smart and hardworking.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Beginning: Three pigs build houses. Middle: Wolf tries to blow them down. End: Pigs are safe in brick house.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Once upon a time, a brave knight went on a quest to save the princess from a dragon.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "The big, red car drove fast down the street.",
            }
        ],
        "builtin",
        None,
...
def seed_grade4_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        reading_id,
        "Theme and Message",
        "Find the deeper meaning in stories",
        [
        ...
        [
            {
                "title": "Example",
                "content": "In 'The Tortoise and the Hare,' the theme is that slow and steady wins the race.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "If a character is walking toward a dark forest, you might predict something scary will happen.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        writing_id,
        "Persuasive Writing",
        "Convince others with your words",
        [
        ...
        [
            {
                "title": "Example",
                "content": "I think students should have longer recess because it helps them focus better in class.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Friend: friendly, friendship, unfriendly, befriend",
            }
        ],
        "builtin",
        None,
...
def seed_grade5_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "If a character is crying and holding a broken toy, you can infer they are sad about the toy.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "A news article informs, an advertisement persuades, a novel entertains.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Topic: Dolphins. Notes: Dolphins are mammals, they live in oceans, they are very intelligent.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "The big dog runs fast. Subject: dog, Predicate: runs",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "The bat flew overhead. (animal) vs. The player swung the bat. (sports equipment)",
            }
        ],
        "builtin",
        None,
...
def seed_grade6_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        reading_id,
        "Literary Devices",
        "Recognize techniques authors use",
        [
        ...
        [
            {
                "title": "Examples",
                "content": "Simile: 'as brave as a lion.' Metaphor: 'the classroom was a zoo.' Personification: 'the wind whispered.'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "First person: 'I walked to school.' Third person: 'She walked to school.'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "The sun shines bright / Like a golden light / Making everything / Feel just right",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Active: 'The dog chased the cat.' Passive: 'The cat was chased by the dog.'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Telephone: 'tele' (far) + 'phone' (sound) = sound from far away",
            }
        ],
        "builtin",
        None,
...
def seed_grade7_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        ...
        "Find hidden meanings in stories",
        [
        ...
        [
            {
                "title": "Example",
                "content": "In a story, a character always carries a key. The key might symbolize freedom or opportunity.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        reading_id,
        "Irony and Sarcasm",
        "Understand when words mean the opposite",
        [
        ...
        [
            {
                "title": "Example",
                "content": "It's ironic when a fire station burns down. It's sarcastic to say 'Great job!' when someone makes a mistake.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Claim: School should start later. Evidence: Students need more sleep. Counterargument: Later start means later dismissal.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Misplaced: 'I saw a dog walking to school.' (Who was walking?) Fixed: 'Walking to school, I saw a dog.'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        vocab_id,
        "SAT Vocabulary Prep",
        "Learn words for standardized tests",
        [
        ...
        [
            {
                "title": "Example",
                "content": "Ubiquitous means everywhere. 'Smartphones are ubiquitous in modern society.'",
            }
        ],
        "builtin",
        None,
...
def seed_grade8_lessons(reading_id, writing_id, grammar_id, vocab_id):
    ...
    lesson_id = add_lesson(
        ...
        "Understand difficult reading material",
        [
        ...
        [
            {
                "title": "Example",
                "content": "When reading a difficult passage, break it into smaller parts and understand each part before moving on.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "When reading an article, ask: What evidence supports this claim? Are there other viewpoints?",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Thesis: Climate change is affecting polar bear populations. Support with facts from scientific studies.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Not parallel: 'I like reading, to write, and swimming.' Parallel: 'I like reading, writing, and swimming.'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Instead of 'big,' use 'substantial' or 'considerable' in academic writing.",
            }
        ],
        "builtin",
        None,
...
def seed_specialized_lessons(
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Haiku: 'Green grass grows tall / In the warm summer sun / Nature's beauty shines'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "In a play, characters speak their lines and move around the stage to tell the story.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "A toy commercial might show kids having fun, but it's really trying to sell the toy to parents.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Before giving a speech, take deep breaths and remind yourself that you know your topic well.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Instead of saying 'You're wrong,' say 'I see it differently because...'",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Who: Local students. What: Won science fair. When: Last Saturday. Where: Community center. Why: Great project.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "How to make a sandwich: 1. Get two slices of bread. 2. Spread peanut butter on one slice. 3. Add jelly. 4. Put slices together.",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "Example",
                "content": "Subject: Meeting Request. Dear Mr. Smith, I would like to schedule a meeting to discuss the project. Best regards, [Your name]",
            }
        ],
        "builtin",
        None,
