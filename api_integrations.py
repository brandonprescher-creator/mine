...
def search_educational_youtube(query: str) -> List[Dict]:
    ...
    educational_channels = {
        ...
        "science": [
            ...
            },
            {
                ...
                "url": "https://www.youtube.com/@NatGeoKids",
            },
        ],
        "reading": [
            {
            ...
            },
            {
                ...
                "channel": "Epic!",
                "url": "https://www.youtube.com/@getepic",
            },
        ],
    }
    ...
    if any(
        word in query_lower
        for word in ["math", "division", "multiplication", "algebra", "geometry"]
    ):
        return educational_channels["math"]
    elif any(
        word in query_lower
        for word in ["science", "biology", "chemistry", "physics", "space"]
    ):
        ...
        "math": [
            {
                ...
                "description": "Free math lessons K-12",
            },
            {
                "title": "CK-12 Math",
                "url": "https://www.ck12.org/math/",
                "description": "Free math textbooks and practice",
            },
            {
                "title": "Math is Fun",
                "url": "https://www.mathsisfun.com/",
                "description": "Math explanations and games",
            },
        ],
        "science": [
            {
                ...
                "description": "Free science textbooks",
            },
            {
                "title": "Khan Academy Science",
                "url": "https://www.khanacademy.org/science",
                "description": "Science lessons and videos",
            },
            {
                "title": "NASA Kids Club",
                "url": "https://www.nasa.gov/kidsclub/",
                "description": "Space and science resources",
            },
        ],
        "reading": [
            {
                ...
                "description": "Free reading passages and lessons",
            },
            {
                "title": "Project Gutenberg",
                "url": "https://www.gutenberg.org/",
                "description": "Free classic books",
            },
            {
                "title": "ReadWorks",
        ...
        "social_studies": [
            {
                ...
                "description": "Civics games and lessons",
            },
            {
                "title": "National Geographic Education",
                "url": "https://education.nationalgeographic.org/",
                "description": "Geography and culture resources",
            },
        ],
    }
        ...
        resources = [
            {
                ...
                "description": "Free lessons in all subjects",
            },
            {
                "title": "CK-12 Foundation",
                "url": "https://www.ck12.org/",
                "description": "Free K-12 textbooks and resources",
            },
        ]
...
def search_all_sources(query: str) -> Dict:
    ...
    if oer:
        results["sources"].append(
            {"source": "Open Educational Resources", "resources": oer}
        )

    # Video suggestions
    videos = search_educational_youtube(query)
    if videos:
        results["sources"].append({"source": "Educational Videos", "videos": videos})
