...
def seed_science_experiments_curriculum():
    ...
    if existing_subjects and any(
        s["name"] == "Science Experiments" for s in existing_subjects
    ):
    ...
    chemistry_id = add_topic(
        experiments_id, "Chemistry Experiments", "Mix, react, and explore chemistry", 1
    )
    physics_id = add_topic(
        experiments_id, "Physics Experiments", "Explore forces, motion, and energy", 2
    )
    biology_id = add_topic(
        experiments_id, "Biology Experiments", "Study living things and nature", 3
    )
    earth_science_id = add_topic(
        experiments_id,
        "Earth Science Experiments",
        "Explore weather, rocks, and Earth",
        4,
    )
    kitchen_science_id = add_topic(
        experiments_id,
        "Kitchen Science",
        "Amazing experiments with food and kitchen items",
        5,
    )
    water_experiments_id = add_topic(
        experiments_id, "Water Experiments", "Explore properties of water", 6
    )
    light_sound_id = add_topic(
        experiments_id, "Light & Sound Experiments", "Investigate light and sound", 7
    )
    electricity_id = add_topic(
        experiments_id,
        "Electricity & Magnetism",
        "Explore electrical and magnetic forces",
        8,
    )
...
def seed_chemistry_experiments(topic_id):
        ...
        [
            {
                ...
                "content": "The vinegar (acid) reacts with baking soda (base) to create carbon dioxide gas, which makes the bubbles and foam!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        topic_id,
        "Rainbow in a Jar",
        "Create colorful density layers",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Different liquids have different densities. Denser liquids sink to the bottom, lighter ones float on top!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Lemon juice is clear on paper, but when heated, it oxidizes and turns brown, revealing your secret message!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Soap molecules have two ends: one likes water, one likes fat. They rush around breaking up fat in milk, making colors swirl!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "As water evaporates, dissolved borax/sugar molecules come together to form solid crystals with regular patterns!",
            }
        ],
        "builtin",
        None,
...
def seed_physics_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        topic_id,
        "Egg Drop Challenge",
        "Protect an egg from a high drop",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Your design must absorb the force of impact. Materials compress and slow the egg down, reducing force!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        "Test different airplane designs",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Different designs have different aerodynamic properties. Wing shape and weight distribution affect flight!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Air rushes out of balloon (action), pushing balloon forward (reaction). This is how real rockets work!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Length affects swing time, but weight doesn't! Longer pendulums swing slower. Gravity pulls it back and forth!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        topic_id,
        "Ramp and Roll",
        "Test how ramps affect rolling objects",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Higher ramps give more potential energy, which converts to kinetic energy, making cars go farther!",
            }
        ],
        "builtin",
        None,
...
def seed_biology_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Seeds contain baby plant and food. Water activates growth. Root grows first to get water, then stem grows to get light!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Water travels up tiny tubes (xylem) in the celery to the leaves. Food coloring shows the path!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        "Create a feeder and observe birds",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Different birds prefer different foods. Observe their beaks, colors, and behaviors. Keep a journal!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        "Examine your unique fingerprints",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Everyone has unique fingerprints! Patterns form before birth and never change. Used for identification!",
            }
        ],
        "builtin",
        None,
...
def seed_earth_science_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Hot water evaporates, rises, hits cold plate, condenses into drops, falls as 'rain'. Just like real rain clouds!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Water wears away soil and carries it downhill, just like rivers erode mountains and create valleys!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "As water evaporates, sugar molecules arrange into crystal structures, like minerals forming rocks!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Weather patterns repeat! By collecting data, you can start to predict weather like a meteorologist!",
            }
        ],
        "builtin",
        None,
...
def seed_kitchen_science_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "CO2 bubbles stick to raisins, making them float up. Bubbles pop at surface, raisins sink. Repeat!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Salt lowers ice's temperature below 32°F, freezing the milk mixture into ice cream!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "As eggs age, air cell inside grows, making egg more buoyant. Floating egg = old egg!",
            }
        ],
        "builtin",
        None,
...
def seed_water_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Water climbs up paper towels due to capillary action, then flows down to empty cup. Red + blue = purple!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Water molecules stick together creating surface tension. Soap breaks these bonds, and pepper rushes away!",
            }
        ],
        "builtin",
        None,
...
def seed_light_sound_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        topic_id,
        "Make a Rainbow",
        "Create a rainbow with a prism or CD",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "White light is made of all colors. CD or prism bends different wavelengths at different angles, separating colors!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        topic_id,
        "String Telephone",
        "Make a telephone with cups and string",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Your voice vibrates the cup, vibrations travel along string, other cup vibrates and creates sound!",
            }
        ],
        "builtin",
        None,
...
def seed_electricity_experiments(topic_id):
    ...
    lesson_id = add_lesson(
        ...
        "Make paper butterflies fly with static",
        [
        ...
        [
            {
                "title": "What's Happening",
                "content": "Rubbing creates static charge on balloon. Opposite charges attract, pulling lightweight butterfly to balloon!",
            }
        ],
        "builtin",
        None,
    ...
    lesson_id = add_lesson(
        ...
        [
            {
                "title": "What's Happening",
                "content": "Magnet's force goes through paper plate and pulls metal paper clip. Magnetic fields pass through non-magnetic materials!",
            }
        ],
        "builtin",
        None,
